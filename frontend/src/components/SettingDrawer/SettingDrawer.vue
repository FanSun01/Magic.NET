  ...
  <div class="setting-drawer">
    <a-drawer
      ...
      <div class="setting-drawer-index-content">
        ...
        <div :style="{ marginBottom: '24px' }">
          <h3 class="setting-drawer-index-title">顶栏主题色</h3>
          <div style="height: 20px">
        ...
        <div v-show="false" :style="{ marginBottom: '24px' }">
          <h3 class="setting-drawer-index-title">菜单主题色</h3>
          <div style="height: 20px">
      ...
      <div v-if="visible" class="setting-drawer-index-handle" @click="toggle" slot="handle">
        <a-icon type="close"/>
      </div>
    </a-drawer>
  </div>
