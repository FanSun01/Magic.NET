  ...
  <a-row :gutter="24" >
    ...
    <a-col :md="19" :sm="24">
      ...
      <a-card :bordered="false">
        ...
        >
          <template slot="operator" v-if="hasPerm('flcForm:add')">
            <a-button @click="$refs.addForm.add()" icon="plus" type="primary" v-if="hasPerm('flcForm:add')">新增表单</a-button>
          </template>
          <span slot="status" slot-scope="text,record" v-if="hasPerm('flcForm:changeStatus')">
            <a-popconfirm
              placement="top"
