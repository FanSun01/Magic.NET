  ...
  <a-modal
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="上传文件夹" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-upload
            v-if="uploadReset"
            :fileList="fileList"
            ...
            <a-button v-else icon="upload" :loading="uploading" :disabled="fileList.length !== 0">上传</a-button>
          </a-upload>
        </a-form-item>
      </a-form>
    </a-spin>
      ...
      handleSubmit() {
        ...
        validateFields((errors, values) => {
          if (!errors) {
            ...
            // 调上传接口
            DocumentUploadFolder(formData).then((res) => {
              if (res.success) {
